...
def orderIncreaseVsRefinement(n):
    ...
    print("     %.3fs           %.3fs" % (pTimer, hTimer))

print("Order increase     Refinement")
for i in range(8):
    orderIncreaseVsRefinement(pow(2, i))
