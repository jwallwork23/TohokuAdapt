...
File("plots/tests/u_h.pvd").write(u_h_DG1)
...
File("plots/tests/e_h.pvd").write(e_h)
...
File("plots/tests/e.pvd").write(e)
errorInError = Function(DG2)
errorInError.dat.data[:] = np.abs(e_h.dat.data - e.dat.data)
File("plots/tests/errorInError.pvd").write(errorInError)