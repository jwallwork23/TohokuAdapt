...
parser.add_argument("-approach1", help="Choose from {'fixedMesh', 'hessianBased', 'DWP', 'DWR'}.")
parser.add_argument("-approach2", help="Choose from {'fixedMesh', 'hessianBased', 'DWP', 'DWR'}.")
